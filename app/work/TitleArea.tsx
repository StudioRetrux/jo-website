...
const FILTERS = ["All", "Healthcare", "Hospitality", "Residential"];
...
export default function TitleArea({ phase, activeFilter, onFilterChange, viewMode, onViewModeChange }: Props) {
