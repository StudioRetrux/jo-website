...
export default function PreloadOther({ target = "work", works = [] }: { target?: PreloadOtherTarget; works?: WorkItem[] }) {
  ...
  return (
    <>
      {target === "about" ? (
        ...
        <WorkSection works={works} open={contentOpen} homeNavigation="route" />
      )}
