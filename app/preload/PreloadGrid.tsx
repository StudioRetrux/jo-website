...
const homeSlideImages = ["/preload2.png", "/preload3.png", "/preload4ld.png"];
...
export default function PreloadGrid() {
  ...
  const slideImages = homeSlideImages;
  ...
  return (
    <>
      ...
      {phase === "home" && <HomeSection carouselReady={homeReady} preloading={!sliderRemoved} />}
    </>
  );
}
